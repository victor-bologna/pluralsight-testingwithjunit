...
public class DurationParser {
    ...
    /**
     * A duration string will typically have two parts:  an integer quantity and a unit, i.e. "2 weeks" or "3 days", for which this method should
    ...
    public static int parseDays(String durationString) {
        ...
        switch (parts.length) {
            ...
            case 1 -> {
                if (parts[0].equalsIgnoreCase("once")) {
                    return 1;
                }
            }
        }
